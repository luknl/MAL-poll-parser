...
// Anime episode URL
$anime = 'http://myanimelist.net/anime/28171/Shokugeki_no_Souma/episode';
...
$length = 4; // Change length to low number for tests, otherwise parsing is way to long for animes with ep > 10
...
for ($i = 0; $i < $length; ++$i)
{
   ...
   $forum_id = 'http://myanimelist.net'.($html2->find($node2, 0)->href).'&pollresults=1';
